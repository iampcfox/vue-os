<template>
    <div id="app" oncontextmenu="return false" onselectstart="return false" ondragstart="return false" onbeforecopy="return false" oncopy=document.selection.empty() onselect=document.selection.empty()>
        <div id="nav">
            ...
            <hsc-menu-style-metal style="margin-left: 8px;z-index: 2;">
                <hsc-menu-bar>
                    ...
                    <hsc-menu-bar-item label="Windows">
                        <hsc-menu-item v-for="w in numberWindows" :key="w.id" :label="w.label" @click="w.isOpen=!w.isOpen" :checked="w.isOpen" />
                    </hsc-menu-bar-item>
                </hsc-menu-bar>
